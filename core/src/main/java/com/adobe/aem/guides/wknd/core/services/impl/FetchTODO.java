...
import static com.adobe.aem.guides.wknd.core.services.impl.FetchTODO.COMPONENT_NAME;
...
public class FetchTODO {
    ...
    private String fetchData() {
        ...
        try {
            // GET Request
            HttpGet request = new HttpGet("https://jsonplaceholder.typicode.com/todos/");
